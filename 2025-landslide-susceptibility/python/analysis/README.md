...
- __data__: Folder storing the data for the analysis. Note that the data has been compressed in the _data_analysis.7z_ due to the large number of files and the data volume. The content of the archive has to be extracted before running the analysis.  